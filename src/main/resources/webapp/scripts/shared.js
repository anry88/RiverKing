(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      achievementLocked: 'Собирайте прогресс, чтобы получить награду.',
      achievementInProgress: 'Продолжайте собирать прогресс.',
    ...
    en: {
      ...
      achievementLocked: 'Earn progress to unlock rewards.',
      achievementInProgress: 'Keep building your progress.',
