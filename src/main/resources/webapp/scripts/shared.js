(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      prizePlayersCount: ({ count, total }) => total ? `В призах: ${count}/${total}` : `В призах: ${count}`,
      day: 'День',
    ...
    en: {
      ...
      prizePlayersCount: ({ count, total }) => total ? `Players in prizes: ${count}/${total}` : `Players in prizes: ${count}`,
      day: 'Day',
