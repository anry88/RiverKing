(() => {
  ...
  const FISH_INFO = {
    ...
    'Жёлтый сомик': { en: 'Yellow Catfish', asset: '/app/assets/fish/zheltyy_somik.png' },
    'Амурский сом': { en: 'Amur Catfish', asset: '/app/assets/fish/amurskiy_som.png' },
    'Ауха': { en: 'Chinese Perch', asset: '/app/assets/fish/auha.png' },
    'Желтощёк': { en: 'Yellowcheek', asset: '/app/assets/fish/zheltoschek.png' },
    'Китайский чукучан': { en: 'Chinese Sucker', asset: '/app/assets/fish/kitayskiy_chukuchan.png' },
    'Янцзынский осётр': { en: 'Yangtze Sturgeon', asset: '/app/assets/fish/yangtze_sturgeon.png' },
    'Китайский осётр': { en: 'Chinese Sturgeon', asset: '/app/assets/fish/chinese_sturgeon.png' },
    'Китайский веслонос': { en: 'Chinese Paddlefish', asset: '/app/assets/fish/chinese_paddlefish.png' },
  ...
  const STRINGS = {
    ru: {
      ...
      eventLeaderboard: 'Зачет',
      eventTotalWeight: 'Клубы: суммарный вес',
      eventTotalCount: 'Клубы: количество рыб',
      eventTopFish: 'Игроки: редкая крупная рыба',
      clubEventTotalWeight: 'Суммарный вес',
      clubEventTotalCount: 'Количество рыб',
      clubEventTopFish: 'Топ рыбы',
    ...
    en: {
      ...
      clubEventTotalWeight: 'Total weight',
      clubEventTotalCount: 'Fish count',
      clubEventTopFish: 'Top fish',
