...
//        setLFWeight(pond, fMyKoi, 0.040)
        setLFWeight(pond, fKoiKohaku, 2.040)
        setLFWeight(pond, fKoiSanke, 2.0)
        setLFWeight(pond, fKoiAsagi, 2.0)
        setLFWeight(pond, fKoiGoshiki, 2.0)
        setLFWeight(pond, fKoiBekko, 2.0)
