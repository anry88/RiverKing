...
object DB {
    ...
    private fun seedIfEmpty() {
        ...
        val fCommonPeaceFreshTetraRodostomus = upsertFish("Тетра родостомус", "common", 0.0035, 0.0015, false, "fresh")
        val fCommonPeaceFreshKarnegiellaMermer = upsertFish("Карнегиелла мраморная", "common", 0.0040, 0.0020, false, "fresh")
        val fCommonPeaceFreshLemonTetra = upsertFish("Тетра лимонная", "common", 0.0040, 0.0020, false, "fresh")
        val fCommonPeaceFreshBlackNeon = upsertFish("Тетра чёрный неон", "common", 0.0035, 0.0015, false, "fresh")
        val fCommonPeaceFreshPenguinTetra = upsertFish("Тетра пингвин", "common", 0.0050, 0.0025, false, "fresh")
        val fCommonPeaceFreshEmberTetra = upsertFish("Тетра огненная", "common", 0.0025, 0.0012, false, "fresh")
        val fCommonPeaceFreshNannostomusMargin = upsertFish("Нанностомус маргинатус", "common", 0.0030, 0.0015, false, "fresh")
        ...
        upsertFish("Жёлтый сомик", "common", 0.25, 0.10, true, "fresh")
        val fCommonPredatorFreshBersh = upsertFish("Берш", "common", 1.1, 0.5, true, "fresh")
        val fCommonPredatorFreshMecherotCommon = upsertFish("Мечерот обыкновенный", "common", 0.35, 0.15, true, "fresh")
        val fCommonPredatorFreshTatia = upsertFish("Татия леопардовая", "common", 0.08, 0.03, true, "fresh")
        val fCommonPredatorFreshMesonauta = upsertFish("Цихлазома мезонаута","common", 0.25, 0.12, true, "fresh")
        ...
        val fUncommonPeaceFreshMetynnis = upsertFish("Метиннис серебристый", "uncommon", 0.60, 0.30, false, "fresh")
        val fUncommonPeaceFreshCorySterbai= upsertFish("Коридорас Штерба", "uncommon", 0.070, 0.030, false, "fresh")
        val fUncommonPeaceFreshTarakatum = upsertFish("Торакатум", "uncommon", 0.25, 0.12, false, "fresh")
        val fUncommonPeaceFreshLeporinus = upsertFish("Лепоринус полосатый", "uncommon", 0.80, 0.40, false, "fresh")
        ...
        upsertFish("Амурский сом", "uncommon", 2.0, 0.9, true, "fresh")
        ...
        val fRarePeaceFreshPterigopliht = upsertFish("Птеригоплихт парчовый", "rare", 4.0, 2.0, false, "fresh")
        val fRarePeaceFreshRedPacu = upsertFish("Паку краснобрюхий", "rare", 8.0, 4.0, false, "fresh")
        ...
        upsertFish("Ауха", "rare", 1.4, 0.6, true, "fresh")
        ...
        val fRarePredatorFreshLeafFish = upsertFish("Рыба-лист амазонская", "rare", 0.06, 0.03, true, "fresh")
        val fRarePredatorFreshMecherotPyatnistiy = upsertFish("Мечерот пятнистый", "rare", 1.4, 0.6, true, "fresh")

        // --- Fish: epic пресные мирные---
        val fEpicPeaceFreshSterlyad= upsertFish("Стерлядь", "epic", 3.0, 1.2, false, "fresh")
        upsertFish("Китайский чукучан", "epic", 3.0, 1.2, false, "fresh")
        ...
        val fEpicPeaceFreshAltum = upsertFish("Скалярия альтум", "epic", 0.35, 0.15, false, "fresh")
        ...
        upsertFish("Желтощёк", "epic", 8.0, 3.5, true, "fresh")
        ...
        val fEpicPredatorFreshBlackKnife = upsertFish("Нож-рыба чёрная","epic", 0.70, 0.30, true, "fresh")
        val fEpicPredatorFreshSomVeslonosiy = upsertFish("Сом веслоносый", "epic", 7.0, 3.0, true, "fresh")
        val fEpicPredatorFreshBrachyplatistomaTiger = upsertFish("Брахиплатистома тигровая","epic",12.0,5.0,true, "fresh")
        ...
        val fMythicPredatorFreshPayara = upsertFish("Паяра", "mythic", 7.0, 3.0, true, "fresh")

        // --- Fish: legendary пресные мирные---
        val fLegendaryPeaceFreshOsetr = upsertFish("Осётр европейский", "legendary", 12.0, 6.0, false, "fresh")
        upsertFish("Янцзынский осётр", "legendary", 10.0, 5.0, false, "fresh")
        upsertFish("Китайский осётр", "legendary", 18.0, 8.0, false, "fresh")

        // --- Fish: legendary пресные хищные---
        val fLegendaryPredatorFreshTaimen  = upsertFish("Таймень", "legendary", 15.0, 7.0, true, "fresh")
        upsertFish("Китайский веслонос", "legendary", 60.0, 25.0, true, "fresh")
        ...
        setLFWeight(amazon, fCommonPeaceFreshNeonTetra,0.75)
        setLFWeight(amazon, fCommonPeaceFreshProhilodus,0.65)
        setLFWeight(amazon, fCommonPeaceFreshOtocinklyus,0.60)
        setLFWeight(amazon, fCommonPeaceFreshTetraRodostomus,0.55)
        setLFWeight(amazon, fCommonPeaceFreshBlackNeon,0.52)
        ...
        setLFWeight(amazon, fUncommonPeaceFreshLeporinus,0.33)
        setLFWeight(amazon, fUncommonPeaceFreshCorySterbai,0.3)
        setLFWeight(amazon, fUncommonPeaceFreshTarakatum,0.28)
        setLFWeight(amazon, fUncommonPeaceFreshMetynnis,0.25)
        setLFWeight(amazon, fRarePeaceFreshRamiresi, 0.25)
        setLFWeight(amazon, fRarePeaceFreshRedPacu,0.24)
        setLFWeight(amazon, fRarePeaceFreshPterigopliht,0.22)
        setLFWeight(amazon, fEpicPeaceFreshPacuBrown, 0.1)
        setLFWeight(amazon, fEpicPeaceFreshDiscus, 0.08)

        // Русло Амазонки хищные
        setLFWeight(amazon, fCommonPredatorFreshMecherotCommon, 0.9)
        setLFWeight(amazon, fCommonPredatorFreshTatia, 0.8)
        setLFWeight(amazon, fCommonPredatorFreshMesonauta, 0.7)
        setLFWeight(amazon, fUncommonPredatorFreshPiranhaRed, 0.5)
        setLFWeight(amazon, fUncommonPredatorFreshGymnotus, 0.45)
        setLFWeight(amazon, fUncommonPredatorFreshPimelodus, 0.4)
        setLFWeight(amazon, fUncommonPredatorFreshSeverum, 0.4)
        setLFWeight(amazon, fRarePredatorFreshOscar, 0.35)
        setLFWeight(amazon, fRarePredatorFreshMecherotPyatnistiy, 0.32)
        setLFWeight(amazon, fRarePredatorFreshSchuchyaCihlida, 0.3)
        setLFWeight(amazon, fRarePredatorFreshBicuda, 0.3)
        setLFWeight(amazon, fRarePredatorFreshPiranhaBlack, 0.25)
        setLFWeight(amazon, fEpicPredatorFreshPeacockOkun, 0.1)
        setLFWeight(amazon, fEpicPredatorFreshElectricEel, 0.08)
        setLFWeight(amazon, fEpicPredatorFreshBlackKnife, 0.07)
        setLFWeight(amazon, fEpicPredatorFreshBrachyplatistomaTiger, 0.65)
        setLFWeight(amazon, fEpicPredatorFreshRedTailSom, 0.06)
        setLFWeight(amazon, fEpicPredatorFreshSomVeslonosiy, 0.05)
        ...
        setLFWeight(amazon, fMythicPredatorFreshPayara,0.35)
        ...
        setLFWeight(igapo, fCommonPeaceFreshBlackNeon,0.92)
        setLFWeight(igapo, fCommonPeaceFreshTetraRodostomus,0.9)
        setLFWeight(igapo, fCommonPeaceFreshKarnegiellaMermer,0.8)
        setLFWeight(igapo, fCommonPeaceFreshCardinalTetra,0.75)
        setLFWeight(igapo, fCommonPeaceFreshEmberTetra,0.70)
        setLFWeight(igapo, fCommonPeaceFreshNannostomus,0.70)
        setLFWeight(igapo, fCommonPeaceFreshOtocinklyus,0.65)
        setLFWeight(igapo, fCommonPeaceFreshNannostomusMargin,0.65)
        setLFWeight(igapo, fCommonPeaceFreshPenguinTetra,0.62)
        setLFWeight(igapo, fCommonPeaceFreshLemonTetra,0.55)
        setLFWeight(igapo, fUncommonPeaceFreshCorySterbai,0.5)
        ...
        setLFWeight(igapo, fUncommonPeaceFreshTarakatum,0.32)
        setLFWeight(igapo, fUncommonPeaceFreshPacuBlack,0.3)
        setLFWeight(igapo, fUncommonPeaceFreshMetynnis,0.25)
        setLFWeight(igapo, fUncommonPeaceFreshLeporinus, 0.22)
        setLFWeight(igapo, fRarePeaceFreshRamiresi, 0.2)
        setLFWeight(igapo, fRarePeaceFreshRedPacu,0.2)
        setLFWeight(igapo, fRarePeaceFreshPterigopliht,0.18)
        setLFWeight(igapo, fEpicPeaceFreshDiscus, 0.1)
        setLFWeight(igapo, fEpicPeaceFreshAltum,0.07)
        setLFWeight(igapo, fEpicPeaceFreshPacuBrown, 0.06)

        // Игапо, затопленный лес хищные
        setLFWeight(igapo, fCommonPredatorFreshTatia, 0.9)
        setLFWeight(igapo, fCommonPredatorFreshMecherotCommon, 0.7)
        setLFWeight(igapo, fCommonPredatorFreshMesonauta, 0.6)
        setLFWeight(igapo, fUncommonPredatorFreshPiranhaRed, 0.5)
        setLFWeight(igapo, fUncommonPredatorFreshGymnotus, 0.45)
        setLFWeight(igapo, fUncommonPredatorFreshPimelodus, 0.4)
        setLFWeight(igapo, fUncommonPredatorFreshSeverum, 0.35)
        setLFWeight(igapo, fRarePredatorFreshOscar, 0.25)
        setLFWeight(igapo, fRarePredatorFreshLeafFish, 0.2)
        ...
        setLFWeight(igapo, fEpicPredatorFreshBlackKnife, 0.07)
        setLFWeight(igapo, fEpicPredatorFreshPeacockOkun, 0.06)
        setLFWeight(igapo, fEpicPredatorFreshAimara, 0.06)
        setLFWeight(igapo, fEpicPredatorFreshSomVeslonosiy, 0.05)
        ...
        setLFWeight(igapo, fMythicPredatorFreshPayara,0.02)
