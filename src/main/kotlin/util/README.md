...
- **`UserMetrics.kt`** — calculates gameplay metrics (online users, active casts, player progress, registration sources) and forwards them to `Metrics` before serving `/metrics`.
