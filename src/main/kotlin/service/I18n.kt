...
object I18n {
    ...
    private val texts = mapOf(
        ...
        "Разблокирует удочку «Роса»" to "Unlocks the Dew rod",
        "Разблокирует удочку «Поток»" to "Unlocks the Stream rod",
        "Разблокирует удочку «Глубь»" to "Unlocks the Abyss rod",
        "Разблокирует удочку «Шторм»" to "Unlocks the Storm rod",
