...
private fun defaultBotCommands(): List<BotCommand> = listOf(
    ...
    BotCommand("event", "View current event leaderboards"),
    BotCommand("daily_rating", "View today's daily rating"),
    BotCommand("club", "Join or manage your club"),
    BotCommand("club_rating", "View the current club weekly rating"),
...
private fun russianBotCommands(): List<BotCommand> = listOf(
    ...
    BotCommand("event", "Таблицы текущего клубного события"),
    BotCommand("daily_rating", "Текущий результат в ежедневном рейтинге"),
    BotCommand("club", "Вступить в клуб или управлять клубом"),
    BotCommand("club_rating", "Рейтинг клуба за текущую неделю"),
