...
private val FISH_IMAGE_PATHS = mapOf(
    ...
    "Тамбаки" to "webapp/assets/fish/tambaki.png",
    "Паку чёрный" to "webapp/assets/fish/paku_cherniy.png",
    "Прохилодус" to "webapp/assets/fish/prohilodus.png",
    "Анциструс" to "webapp/assets/fish/ancistrus.png",
    "Отоцинклюс" to "webapp/assets/fish/otocinklyus.png",
    "Неоновая тетра" to "webapp/assets/fish/tetra_neonovaya.png",
    "Тернеция" to "webapp/assets/fish/tetra_chernaya.png",
    "Арапайма" to "webapp/assets/fish/arapayma.png",
    "Пиранья краснобрюхая" to "webapp/assets/fish/piranya_krasnopuzaya.png",
    "Трайра" to "webapp/assets/fish/zubatka.png",
    "Ацестринх" to "webapp/assets/fish/bikuda.png",
    "Электрический угорь" to "webapp/assets/fish/ugor_elektricheskiy.png",
    "Краснохвостый сом" to "webapp/assets/fish/krasnohvostiy_som.png",
    "Пираиба" to "webapp/assets/fish/piraiba.png",
    "Дискус" to "webapp/assets/fish/diskus.png",
    "Скалярия" to "webapp/assets/fish/ryba_angel.png",
    "Апистограмма Агассиза" to "webapp/assets/fish/apistogramma_agassiza.png",
    "Кардинальная тетра" to "webapp/assets/fish/tetra_kardinal.png",
    "Коридорас панда" to "webapp/assets/fish/koridorus_panda.png",
    "Нанностомус" to "webapp/assets/fish/nannostomus.png",
    "Рамирези" to "webapp/assets/fish/ramirezi.png",
    "Аравана чёрная" to "webapp/assets/fish/aravana_chernaya.png",
    "Оскар" to "webapp/assets/fish/oskar.png",
    ...
    "Пятнистая кефаль" to "webapp/assets/fish/kefal_pyatnistaya.png",
    ...
    "Золотистый сиган" to "webapp/assets/fish/zolotistiy_shiponog.png",
    "Бычок мангровый" to "webapp/assets/fish/bychok_mangroviy.png",
    "Баррамунди" to "webapp/assets/fish/barramundi.png",
    "Снук" to "webapp/assets/fish/snuk.png",
    "Мангровый луциан" to "webapp/assets/fish/mangroviy_snapper.png",
    "Тарпон" to "webapp/assets/fish/tarpon.png",
    "Морской сом" to "webapp/assets/fish/morskoy_som.png",
    "Морской сарган" to "webapp/assets/fish/morskoy_sargan.png",
    "Голубой каранкс" to "webapp/assets/fish/goluboy_trevalli.png",
    "Рыба-попугай" to "webapp/assets/fish/ryba_popugay.png",
    "Императорский ангел" to "webapp/assets/fish/angel_imperatorskiy.png",
    "Голубой хирург" to "webapp/assets/fish/hirurg_goluboy.png",
    "Нитеносная бабочка" to "webapp/assets/fish/babochka_klinopolosaya.png",
    "Синяя хризиптера" to "webapp/assets/fish/damsel_siniy.png",
    ...
    "Большая барракуда" to "webapp/assets/fish/barrakuda_bolschaya.png",
    "Гигантский каранкс" to "webapp/assets/fish/gigantskiy_karanks.png",
    "Пермит" to "webapp/assets/fish/permit.png",
    "Альбула" to "webapp/assets/fish/kostlyavaya_ryba.png",
    "Испанская скумбрия" to "webapp/assets/fish/ispanskaya_makrel.png",
    "Коралловая форель" to "webapp/assets/fish/koralloviy_grupper.png",
    ...
    "Чёрный амур" to "webapp/assets/fish/cherniy_amur.png",
    "Змееголов северный" to "webapp/assets/fish/zmeegolov_severniy.png",
    "Амурская щука" to "webapp/assets/fish/amurskaya_schuka.png",
    "Кристивомер" to "webapp/assets/fish/kristivomer.png",
    "Дунайский лосось" to "webapp/assets/fish/dunaiskiy_losos.png",
    ...
    "Чёрный снук" to "webapp/assets/fish/chyorniy_snuk.png",
