...
private val FISH_IMAGE_PATHS = mapOf(
    ...
    "Сом европейский" to "webapp/assets/fish/som.png",
    "Осётр европейский" to "webapp/assets/fish/osetr.png",
    ...
    "Сиг обыкновенный" to "webapp/assets/fish/sig.png",
    ...
    "Амур белый" to "webapp/assets/fish/beliy_amur.png",
    "Угорь европейский" to "webapp/assets/fish/ugor_evropeyskiy.png",
    "Стерлядь" to "webapp/assets/fish/sterlyad.png",
    "Кефаль-лобан" to "webapp/assets/fish/kefal.png",
    "Камбала морская" to "webapp/assets/fish/kambala.png",
    "Сельдь" to "webapp/assets/fish/seld.png",
    "Ставрида" to "webapp/assets/fish/stavrida.png",
    "Тихоокеанский клювач" to "webapp/assets/fish/klyuvach_pacificocean.png",
    "Треска" to "webapp/assets/fish/treska.png",
    "Сайда" to "webapp/assets/fish/sayda.png",
    "Мерланг" to "webapp/assets/fish/merlang.png",
    "Форель морская" to "webapp/assets/fish/morskaya_forel.png",
    ...
    "Горбуша" to "webapp/assets/fish/gorbusha.png",
    "Кета" to "webapp/assets/fish/keta.png",
    "Белуга" to "webapp/assets/fish/beluga.png",
    "Ёрш" to "webapp/assets/fish/yorsh.png",
    "Берш" to "webapp/assets/fish/bersh.png",
    ...
    "Вьюн" to "webapp/assets/fish/vyun.png",
    "Вобла" to "webapp/assets/fish/vobla.png",
    "Гольян" to "webapp/assets/fish/golyan.png",
    "Язь" to "webapp/assets/fish/yaz.png",
    "Бычок-кругляк" to "webapp/assets/fish/bychyok.png",
    "Килька" to "webapp/assets/fish/kilka.png",
    "Мойва" to "webapp/assets/fish/mojva.png",
    "Тарань" to "webapp/assets/fish/taran.png",
    "Сардина" to "webapp/assets/fish/sardina.png",
    "Анчоус европейский" to "webapp/assets/fish/anchous.png",
    ...
    "Катран обыкновенный" to "webapp/assets/fish/katran_simple.png",
    ...
    "Паку бурый" to "webapp/assets/fish/tambaki.png",
    "Паку краснобрюхий" to "webapp/assets/fish/paku_krasnobryuhiy.png",
    "Паку чёрный" to "webapp/assets/fish/paku_cherniy.png",
    "Прохилодус красноштриховый" to "webapp/assets/fish/prohilodus.png",
    "Лепоринус полосатый" to "webapp/assets/fish/leporinus_polosatiy.png",
    "Метиннис серебристый" to "webapp/assets/fish/metinnis_serebristiy.png",
    "Пелядь" to "webapp/assets/fish/pelyad.png",
    "Омуль арктический" to "webapp/assets/fish/omul_arcticheskiy.png",
    "Муксун" to "webapp/assets/fish/muksun.png",
    "Анциструс обыкновенный" to "webapp/assets/fish/ancistrus.png",
    "Птеригоплихт парчовый" to "webapp/assets/fish/pterigopliht_parchoviy.png",
    "Отоцинклюс широкополосый" to "webapp/assets/fish/otocinklyus.png",
    "Карнегиелла мраморная" to "webapp/assets/fish/karnegiella_mramornaya.png",
    "Тетра неоновая" to "webapp/assets/fish/tetra_neonovaya.png",
    "Тернеция чёрная" to "webapp/assets/fish/tetra_chernaya.png",
    "Рыба-лист амазонская" to "webapp/assets/fish/ryba_list_amazonskaya.png",
    "Арапайма" to "webapp/assets/fish/arapayma.png",
    "Ленок" to "webapp/assets/fish/lenok.png",
    "Пиранья краснобрюхая" to "webapp/assets/fish/piranya_krasnopuzaya.png",
    "Бикуда" to "webapp/assets/fish/bikuda.png",
    "Угорь электрический" to "webapp/assets/fish/ugor_elektricheskiy.png",
    "Сом краснохвостый" to "webapp/assets/fish/krasnohvostiy_som.png",
    "Пимелодус пятнистый" to "webapp/assets/fish/pimelodus_pyatnistiy.png",
    "Сом веслоносый" to "webapp/assets/fish/som_veslonosiy.png",
    "Пираиба" to "webapp/assets/fish/piraiba.png",
    "Дискус обыкновенный" to "webapp/assets/fish/diskus.png",
    "Скалярия альтум" to "webapp/assets/fish/skalyaria_altum.png",
    ...
    "Тетра лимонная" to "webapp/assets/fish/tetra_limonnaya.png",
    "Тетра огненная" to "webapp/assets/fish/tetra_ognennaya.png",
    "Тетра пингвин" to "webapp/assets/fish/tetra_pingvin.png",
    "Тетра родостомус" to "webapp/assets/fish/tetra_rodostomus.png",
    "Тетра чёрный неон" to "webapp/assets/fish/tetra_black_neon.png",
    "Коридорас панда" to "webapp/assets/fish/koridorus_panda.png",
    "Коридорас Штерба" to "webapp/assets/fish/koridoras_shterba.png",
    "Татия леопардовая" to "webapp/assets/fish/tatiya_leopardovaya.png",
    "Торакатум" to "webapp/assets/fish/torakatum.png",
    "Нанностомус трифасциатус" to "webapp/assets/fish/nannostomus.png",
    "Нанностомус маргинатус" to "webapp/assets/fish/nannostomus_marginatus.png",
    "Рамирези" to "webapp/assets/fish/ramirezi.png",
    "Аравана чёрная" to "webapp/assets/fish/aravana_chernaya.png",
    "Астронотус глазчатый" to "webapp/assets/fish/oskar.png",
    "Аймара" to "webapp/assets/fish/aymara.png",
    "Псевдоплатистома тигровая" to "webapp/assets/fish/surubin.png",
    "Брахиплатистома тигровая" to "webapp/assets/fish/brahiplatistoma_tigrovaya.png",
    "Пиранья чёрная" to "webapp/assets/fish/piranya_chernaya.png",
    "Паяра" to "webapp/assets/fish/payara.png",
    "Мечерот обыкновенный" to "webapp/assets/fish/mecherot_common.png",
    "Мечерот пятнистый" to "webapp/assets/fish/mecherot_pyatnistiy.png",
    "Гимнотус угревидный" to "webapp/assets/fish/gimnotus_ugrevidniy.png",
    "Нож-рыба чёрная" to "webapp/assets/fish/ryba_nozh_chernaya.png",
    "Щучья цихлида" to "webapp/assets/fish/schuchya_cihlida.png",
    "Павлиний окунь" to "webapp/assets/fish/pavliniy_okun.png",
    "Цихлазома мезонаута" to "webapp/assets/fish/cihlazoma_mezonauta.png",
    "Цихлазома северум" to "webapp/assets/fish/cihlazoma_severum.png",
    "Молочная рыба" to "webapp/assets/fish/molochnaya_ryba.png",
    "Кефаль пятнистая" to "webapp/assets/fish/kefal_pyatnistaya.png",
    "Тиляпия мозамбикская" to "webapp/assets/fish/tilyapiya_mozambikskaya.png",
    "Анчоус тропический" to "webapp/assets/fish/anchous_tropicheskiy.png",
    "Сардина индийская" to "webapp/assets/fish/sardina_indiyskaya.png",
    "Сиган золотистый" to "webapp/assets/fish/zolotistiy_shiponog.png",
    "Бычок-пчёлка" to "webapp/assets/fish/bychok_mangroviy.png",
    "Баррамунди" to "webapp/assets/fish/barramundi.png",
    "Снук" to "webapp/assets/fish/snuk.png",
    "Луциан мангровый" to "webapp/assets/fish/mangroviy_snapper.png",
    "Тарпон" to "webapp/assets/fish/tarpon.png",
    "Сом морской" to "webapp/assets/fish/morskoy_som.png",
    "Сарган морской" to "webapp/assets/fish/morskoy_sargan.png",
    "Каранкс голубой" to "webapp/assets/fish/goluboy_trevalli.png",
    "Рыба-попугай" to "webapp/assets/fish/ryba_popugay.png",
    "Ангел императорский" to "webapp/assets/fish/angel_imperatorskiy.png",
    "Хирург голубой" to "webapp/assets/fish/hirurg_goluboy.png",
    "Бабочка нитеносная" to "webapp/assets/fish/babochka_klinopolosaya.png",
    "Хризиптера синяя" to "webapp/assets/fish/damsel_siniy.png",
    "Фузилёр жёлтохвостый" to "webapp/assets/fish/fuziler_zheltohvostiy.png",
    "Барабулька тропическая" to "webapp/assets/fish/barabulka_tropicheskaya.png",
    "Барракуда большая" to "webapp/assets/fish/barrakuda_bolschaya.png",
    "Конгер" to "webapp/assets/fish/konger.png",
    "Каранкс гигантский" to "webapp/assets/fish/gigantskiy_karanks.png",
    ...
    "Карп кои (Сёва Сансёку)" to "webapp/assets/fish/koi_showa_sanshoku.png",
    "Карп кои (Уцуримоно)" to "webapp/assets/fish/koi_utsurimono.png",
    "Карп кои (Бэкко)" to "webapp/assets/fish/koi_bekko.png",
    "Карп кои (Тантё)" to "webapp/assets/fish/koi_tancho.png",
    "Карп кои (Асаги)" to "webapp/assets/fish/koi_asagi.png",
    "Карп кои (Сюсуй)" to "webapp/assets/fish/koi_shusui.png",
    "Карп кои (Коромо)" to "webapp/assets/fish/koi_koromo.png",
    "Карп кои (Кингинрин)" to "webapp/assets/fish/koi_kinginrin.png",
    "Карп кои (Каваримоно)" to "webapp/assets/fish/koi_kawarimono.png",
    "Карп кои (Огон)" to "webapp/assets/fish/koi_ogon.png",
    "Карп кои (Хикари-моёмоно)" to "webapp/assets/fish/koi_hikari_moyomono.png",
    "Карп кои (Госики)" to "webapp/assets/fish/koi_goshiki.png",
    ...
    "Лосось дунайский" to "webapp/assets/fish/dunaiskiy_losos.png",
    "Зунгаро" to "webapp/assets/fish/zungaro.png",
    "Скат моторо" to "webapp/assets/fish/skat_motoro.png",
    "Пеленгас" to "webapp/assets/fish/pelengas.png",
    "Вырезуб" to "webapp/assets/fish/vyrezub.png",
    "Кубера" to "webapp/assets/fish/kubera.png",
    "Мурена европейская" to "webapp/assets/fish/murena_european.png",
    "Мурена звёздчатая" to "webapp/assets/fish/murena_zvezdchataya.png",
    "Мурена гигантская" to "webapp/assets/fish/murena_gigantskaya.png",
    "Зубатка пятнистая" to "webapp/assets/fish/zubatka_pyatnistaya.png",
    "Тунец желтоперый" to "webapp/assets/fish/tunec_zeltoperiy.png",
    "Снук чёрный" to "webapp/assets/fish/chyorniy_snuk.png",
    "Рыба-наполеон" to "webapp/assets/fish/ryba_napoleon.png",
    "Рыба-клоун" to "webapp/assets/fish/ryba_kloun.png",
    "Кефаль мангровая" to "webapp/assets/fish/kefal_mangrovaya.png",
    "Сельдь тихоокеанская" to "webapp/assets/fish/seld_tihookeanskaya.png",
    "Хромис рифовый" to "webapp/assets/fish/hromis_rifoviy.png",
    "Дамсел жёлтохвостый" to "webapp/assets/fish/damsel_zheltohvostiy.png",
    "Морской конёк" to "webapp/assets/fish/morskoy_konek.png",
    "Идол мавританский" to "webapp/assets/fish/idol_mavritanskiy.png",
    "Рыба-бабочка полосатая" to "webapp/assets/fish/ryba_babochka_polosataya.png",
    "Гобиодон голубопятнистый" to "webapp/assets/fish/gobiodon_golubopyatnistiy.png",
    "Сиган коричневопятнистый" to "webapp/assets/fish/sigan_korichnevopyatnistiy.png",
    "Хирург полосатый" to "webapp/assets/fish/hirurg_polosatiy.png",
    "Луциан серебристо-пятнистый" to "webapp/assets/fish/lucian_serebristo-pyatnistiy.png",
    "Скорпена бородатая" to "webapp/assets/fish/skorpena_borodataya.png",
    "Барракуда полосатая" to "webapp/assets/fish/barrakuda_polosataya.png",
    "Каранкс шестиполосый" to "webapp/assets/fish/karanks_polosatiy.png",
    "Группер леопардовый коралловый" to "webapp/assets/fish/grupper_leopardoviy_koralloviy.png",
    "Иглорыл-агухон" to "webapp/assets/fish/igloryl-aguhon.png",
    "Акула рифовая чёрнопёрая" to "webapp/assets/fish/akula_rifovaya_chernoperaya.png",
    "Губан-чистильщик" to "webapp/assets/fish/guban-chistilschik.png",
    "Сержант-майор атлантический" to "webapp/assets/fish/sergant-major_atlanticheskiy.png",
    "Грамма королевская" to "webapp/assets/fish/gramma_korolevskaya.png",
    "Ангел королевский" to "webapp/assets/fish/angel_korolevskiy.png",
...
private val LOCATION_BACKGROUNDS = run {
    val base = mapOf(
        ...
        "Русло Амазонки" to "webapp/assets/originals/backgrounds/amazon_riverbed.png",
